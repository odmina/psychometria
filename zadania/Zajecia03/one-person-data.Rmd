...
```{r}
plot(seq(1, 100, 1), small_data$X_o, xlab = "pomiar", ylab = "wynik", main="Hipotetyczne wyniki kolejnych pomiarów tym samym testem", sub = "Czerwona linia oznacza średni wynik pomiaru")
